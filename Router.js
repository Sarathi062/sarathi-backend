...
import { loginMentor,loginMentee, registerMentor,registerMentee, sendOTP, verifyOTP} from './controllers/authController.js';
import { authenticateToken, getProfileMentee, getProfileMentor, getDashboardMentor, getEditMentor, getDashboardMentee ,registersession,createSession,getSession,getMentors ,getSessiondetails,auth,callback,addevent,getUserCalendar,deleteSession} from './controllers/profileController.js';
...
router.route('sessions/:session._id').delete(authenticateToken,deleteSession);
